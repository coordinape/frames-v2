...
export default function Loading() {
  return (
    <>
      <Header />
      <div className="animate-pulse max-w-2xl mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-6">
          <button className="h-10 w-32 bg-white/10 rounded-lg">
            <div className="flex items-center gap-2"></div>
          </button>
          <div className="flex-1"></div>
          <button className="h-10 w-32 bg-white/10 rounded-lg"></button>
        </div>
