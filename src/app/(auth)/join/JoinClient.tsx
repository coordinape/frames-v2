    ...
    <div className="min-h-screen bg-base-blue text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          ...
          {/* Description */}
          <p className="text-center mb-12 opacity-90 px-8">Get listed on thecreators directory for better discovery and collaboration opportunities.</p>

          {/* Requirements */}
          <div className="bg-[#0052CC] bg-opacity-30 rounded-xl p-6 mb-8">
            <h2 className="text-sm uppercase tracking-wider mb-4 opacity-80">Requirements</h2>
          ...
          <div className="flex items-center justify-center gap-2 mb-4 text-sm">
            ...
            <div className="flex items-center">
              <img src="https://api.samplefaces.com/face?width=32" alt="Profile" className="w-5 h-5 rounded-full mr-2" />
          ...
          <div className="space-y-3">
            <button className="w-full bg-[#0052CC] text-white py-3 rounded-xl font-medium hover:bg-[#0047B3] transition-colors" onClick={() => (window.location.href = "/join/requirements")}>
              Check requirements
            </button>
